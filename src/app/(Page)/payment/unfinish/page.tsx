const UnFinishPagePayment = () => {
    const whatsappLink = `https://wa.me/${'+6281326021382'}`
    return (
        <div className="min-h-screen flex items-center justify-center bg-gray-100">
            <div className="bg-white p-8 rounded-lg shadow-md text-center">
                <h1 className="text-3xl font-bold text-orange-500 mb-4">Payment Unfinished!</h1>
                <p className="text-lg mb-6">It looks like your payment was not completed. Please try again or contact our customer support for help.</p>
...
export default UnFinishPagePayment;